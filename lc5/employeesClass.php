...
foeach($employeesData as $key=>$value)
{
    list($lastname, $firstname, $phoneNumber, $email, $address, $zipCode, $city)=explode(";",$key);
    $employees[$key]=new employee($lastname, $firstname, $phoneNumber, $email, $address, $zipCode, $city)
}
